      ...
      <div className="glass border-t border-white/[0.06]">
        ...
        {isExpanded && (
          <motion.div
            ...
            className="border-b border-white/[0.06] max-h-48 overflow-y-auto"
          >
            {tracks.map((t, i) => (
              <button
                key={i}
                ...
                className={`w-full flex items-center justify-between px-6 py-3 text-sm hover:bg-white/[0.03] transition-colors ${
                  i === currentTrack
              ...
              >
                <span>
                  <span className="text-white/30 mr-3">{t.episode}</span>
                  {t.title}
                </span>
                <span className="text-white/30">{t.duration}</span>
              </button>
            ))}
          </motion.div>
        )}
        ...
        <div className="px-4 py-3">
          <div className="max-w-7xl mx-auto flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#E47D08] to-[#FF8D28] flex items-center justify-center shrink-0">
