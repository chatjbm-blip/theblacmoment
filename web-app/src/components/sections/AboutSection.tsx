  ...
  return (
    <section className="relative py-24 md:py-32 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#E47D08]/8 rounded-full blur-[180px]" />
      </div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-4 md:-right-8 glass rounded-2xl p-4 max-w-[240px]"
              >
              ...
              <motion.div
                ...
                className="absolute top-6 -left-4 md:-left-8 flex flex-col gap-2"
              >
                {["Culture & Society", "Actionist", "The Grind"].map(
                  (cat, i) => (
                    <span
                      key={cat}
                      className="px-3 py-1.5 rounded-full bg-[#E47D08]/90 text-white text-xs font-semibold shadow-lg backdrop-blur-sm"
            ...
            <div className="grid gap-4">
              {categories.map((cat, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-[#E47D08]/20 transition-all duration-300 group"
                >
                  <div className="p-2.5 rounded-xl bg-[#E47D08]/10 group-hover:bg-[#E47D08]/20 transition-colors">
                    <cat.icon size={20} className="text-[#FF8D28]" />
                  </div>
                  <div>
